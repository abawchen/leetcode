        ...
        for i in xrange(len(nums)-3):
            for j in xrange(i+1, len(nums)-2):
                ...
                while k < l:
                    ...
                    if tmp > target and nums[k] > 0:
                        break

                    val = tmp + nums[l]
                    if target == val:
                        answers.append((nums[i], nums[j], nums[k], nums[l]))
                        k += 1
                    elif val > target:
                        if tmp + nums[k+1] > target:
                            break
                        l -= 1
                    else:
                        if val - nums[k] + nums[l-1] < target:
                            break
                        k += 1

        
        return [ list(s) for s in list(set(answers)) ]
...
# [[-1, 0, 0, 1], [-1, -1, 0, 2], [-4, 0, 2, 2], [-4, -1, 1, 4], [-4, 0, 0, 4]]
print "=================================================================================================="
...
print s.fourSum([-471,-434,-418,-395,-360,-357,-351,-342,-317,-315,-313,-273,-272,-249,-240,-216,-215,-214,-209,-198,-179,-164,-161,-141,-139,-131,-103,-97,-81,-64,-55,-29,11,40,40,45,64,87,95,101,115,121,149,185,230,230,232,251,266,274,277,287,300,325,334,335,340,383,389,426,426,427,457,471,494], 2705)
# []
print "=================================================================================================="
